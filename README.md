...
- Extension code
  ...
  - `ipc.ts`: Handles communication between the Arqon Maestro app and the Chrome extension. Also determines which command handler to send each incoming command to.
